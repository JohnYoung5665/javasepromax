package com.rockstar.datetest.calendartest;
...
public class Test1 {
    ...
    public static void main(String[] args) {
        ...
        c.set(Calendar.MONTH, 7);//默认+1  实际为7月  下面修改
        ...
        //java中Calendar类中，把索引对应的数字都定义成常量
        int year = c.get(Calendar.YEAR);
        int month = c.get(Calendar.MONTH) + 1;//默认0 为 1月
